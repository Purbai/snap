...
//### Stage 4
//
//Create a Player class and enable the snap game to be multiple players, with the users taking it in turns to go. If the snap occurs on the users turn, they win.
//
